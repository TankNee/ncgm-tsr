...
class Relation(object):
    ...
    def __eq__(self, rl):
        ...
        if len(this_ft) == 0 or len(this_tt) == 0 or len(rl_ft) == 0 or len(rl_tt) == 0:
            print(
                "Warning: Text comparison of 0-length strings after normalization",
                file=sys.stderr,
            )
        ...
        return (
            this_ft == rl_ft
            and this_tt == rl_tt
            and self.direction == rl.direction
            and self.no_blanks == rl.no_blanks
        )
    ...
    def equal(self, rl, cmp_blank=True):
        ...
        return (
            ...
            and this_tt == rl_tt
            and self.direction == rl.direction
            and (self.no_blanks == rl.no_blanks if cmp_blank else True)
        )
