...
class Edge(object):
    ...
    def get_features(self):
        ...
        return {
            ...
            "relative (table) Euler distance": math.sqrt(
                (x_dis / tab_w) ** 2 + (y_dis / tab_h) ** 2
            ),
            "relative (chunk) Euler distance": math.sqrt(
                (x_dis / c_w) ** 2 + (y_dis / c_h) ** 2
            ),
            ...
            "relative (table) center Euler distance": math.sqrt(
                (c_x_dis / tab_w) ** 2 + (c_y_dis / tab_h) ** 2
            ),
            "relative (chunk) center Euler distance": math.sqrt(
                (c_x_dis / c_w) ** 2 + (c_y_dis / c_h) ** 2
            ),
        }
